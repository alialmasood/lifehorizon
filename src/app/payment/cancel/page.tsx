      ...
      <div className="max-w-md mx-auto">
        <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
            ...
            <div className="bg-gray-50 rounded-lg p-4 mb-6">
              {transactionId && (
                <>
                  ...
                  <p className="font-mono text-sm text-gray-700 break-all mb-2">{transactionId}</p>
                </>
              )}
              {amount && (
                <>
                  <p className="text-sm text-gray-500 mb-1">المبلغ المطلوب:</p>
                  <p className="font-mono text-sm text-gray-700">{amount} ريال</p>
                </>
              )}
            </div>
          )}
          ...
          <div className="space-y-3">
            <Link
              href="/"
              className="block w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold py-3 px-6 rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-200 text-center"
            >
